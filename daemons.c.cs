...
partial class Rogue
{
    ...
    void unconfuse(int ignored)
    {
        player.t_flags &= ~ISHUH;
        msg("you feel less {0} now", choose_str("trippy", "confused"));
    }

    // Turn off the ability to see invisible
    void unsee(int ignored)
    {
        THING th;
