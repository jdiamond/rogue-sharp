...
partial class Rogue
{
    ...
    void quaff()
    {
        ...
        switch (obj.o_which)
        {
            ...
            case P_MFIND:
                ...
                fuse(turn_see_fuse, 1, HUHDURATION, AFTER);
                if (!turn_see(0))
                    msg("you have a {0} feeling for a moment, then it passes",
    ...
    bool is_magic(THING obj)
    {
        ...
        {
            case ARMOR:
                return (bool)(((obj.o_flags & ISPROT) != 0) || obj.o_arm != a_class[obj.o_which]);
            case WEAPON:
    ...
    void turn_see_fuse(int turn_off)
    {
        turn_see(turn_off);
    }

    // Put on or off seeing monsters on this level
    bool turn_see(int turn_off)
    {
        THING mp;
