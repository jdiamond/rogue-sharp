...
partial class Rogue
{
    int[] id_type = new[] { 0, 0, 0, 0, 0, POTION, SCROLL, WEAPON, ARMOR, R_OR_S };
    ...
    void read_scroll()
    {
        ...
        switch (obj.o_which)
        {
            case S_CONFUSE:
                ...
                msg("your hands begin to glow {0}", pick_color("red"));
                break;
            case S_ARMOR:
                if (cur_armor != null)
                {
                    ...
                    msg("your armor glows {0} for a moment", pick_color("silver"));
                }
                break;
            case S_HOLD:
                /*
            ...
            case S_CREATE:
                ...
                for (y = hero.y - 1; y <= hero.y + 1; y++)
                    for (x = hero.x - 1; x <= hero.x + 1; x++)
                         ...
                         */
                        else if (step_ok((char)(ch = winat(y, x))))
                        {
            ...
            case S_ID_R_OR_S:
                {
                    ...
                    msg("this scroll is an {0} scroll", scr_info[obj.o_which].oi_name);
            ...
            case S_ENCH:
                ...
                else
                {
                    ...
                    if (rnd(2) == 0)
                        ...
                        cur_weapon.o_dplus++;
                    msg("your {0} glows {0} for a moment",
